...
function App() {
    return (
        <div className="relative overflow-hidden bg-[#070302] font-sans text-gray-100 antialiased">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-[56rem] rounded-full bg-[#39160b] opacity-40 blur-[220px]" />
