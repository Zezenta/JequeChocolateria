const Hero = () => (
    <section className="relative isolate bg-gradient-to-b from-[#2B1207]/70 via-[#1A0804]/80 to-transparent py-24">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-start gap-16 px-6 sm:px-8 lg:flex-row lg:items-center lg:gap-24">
            <div className="max-w-xl space-y-8">
                ...
                <h1 className="font-serif text-5xl leading-tight text-[#D4AF37] sm:text-6xl">
                    Sabores de Dubái, hechos en Ecuador.
                </h1>
                <p className="text-base leading-relaxed text-gray-200 sm:text-lg">
                    Conoce Jeque Chocolatería — fusión artesanal de cacao
                    ecuatoriano y recetas árabes. Elaboramos barras premium con
                    rellenos exuberantes inspirados en los zocos de Dubái,
                    pensadas para deleitar paladares exigentes en Ecuador,
                    Colombia y Perú.
                </p>
            ...
            <div className="flex w-full max-w-sm flex-col items-center gap-6 lg:items-end">
                <p className="text-xs uppercase tracking-[0.35em] text-[#D4AF37]/70">
                    Aquí empezará la barra de chocolate en 3D de costado
                </p>
            </div>
        </div>
    </section>
