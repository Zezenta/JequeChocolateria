const Hero = () => {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute left-1/2 top-5 h-[320px] w-[320px] -translate-x-1/2 rounded-full bg-[#f4e3b2]/6 blur-[140px]" />

            {/* Layout stretches taller on large screens so the bar has room to float. */}
            <div className="relative mx-auto flex min-h-[70vh] w-full max-w-7xl flex-col gap-16 px-6 sm:px-8 lg:min-h-[80vh] lg:flex-row lg:items-center lg:gap-24 xl:min-h-[92vh]">
