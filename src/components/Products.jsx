...
const Products = () => (
    <section className="bg-gradient-to-b from-transparent via-[#120604]/80 to-transparent py-24">
        <div className="mx-auto max-w-6xl space-y-14 px-6 sm:px-8">
            <div className="max-w-2xl space-y-4">
                ...
                <p className="text-base leading-relaxed text-gray-200">
                    Diseñamos lotes limitados con procesos de templado lento y
                    empaques listos para retail gourmet, duty free y amenities
                    de lujo. Ingredientes nobles, trazabilidad y consistencia.
                </p>
            </div>
